...
| BUG-002 | `context-engine-transcript-fence.test.js` — `BUG-002: current-turn transcript fencing` | Required host contracts, matching transcript admission, all fenced rows treated as history, repeated-text author separation, legacy current-row behavior, and stateless idempotent advancement |
